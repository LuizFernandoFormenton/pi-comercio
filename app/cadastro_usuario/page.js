        ...
        <div className="align-self-center border rounded p-4 w-100" style={{ maxWidth: "650px" }}>
          ...
          <form onSubmit={salvar} className="row g-3">
            ...
            <div className="col-12">
              ...
              <input onChange={e => alteraNome(e.target.value)} id="nome" className="form-control" />
            </div>  

            {/* CPF */}
            <div className="col-md-6">
              <label htmlFor="cpf" className="form-label">CPF *</label>
              <input onChange={e => alteraCpf(e.target.value)} id="cpf" className="form-control" />
            </div>

            {/* Telefone */}
            <div className="col-md-6">
              <label htmlFor="telefone" className="form-label">Telefone *</label>
              <input onChange={e => alteraTelefone(e.target.value)} id="telefone" type="tel" className="form-control" />
            </div>

            {/* Email */}
            <div className="col-12">
              <label htmlFor="email" className="form-label">Email *</label>
              <input onChange={e => alteraEmail(e.target.value)} id="email" type="email" className="form-control" />
            </div>

            {/* Senha */}
            <div className="col-md-6">
              <label htmlFor="senha" className="form-label">Senha *</label>
              <input onChange={e => alteraSenha(e.target.value)} id="senha" type="password" className="form-control" />
            </div>
