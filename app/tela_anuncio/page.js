...
export default function CadastroAnuncioModal() {
  ...
  return (
    <div className="container mt-5 pagina-anuncios">
      ...
      <div className="input-group busca-anuncios mb-4">
        <input
          type="text"
          className="form-control"
          placeholder="Pesquisar..."
        />
        <button className="input-group-text botao-busca-anuncios">🔍</button>
      </div>

      <button
        className="btn btn-laranja mb-4"
      ...
      <div className="modal fade" id="modalCadastroAnuncio" tabIndex="-1">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content shadow-lg modal-anuncios">
            <div className="modal-header border-0">
              <h1 className="modal-title fs-5 titulo-modal-anuncios">Cadastre seu anúncio</h1>
              <button type="button" className="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <div className="modal-body corpo-modal-anuncios">
              <form onSubmit={inscrever}>
                ...
                <div className="modal-footer px-0 pb-0 mt-4 border-0">
                  <button
                    type="submit"
                    className="btn btn-laranja px-4"
                  >
                    Enviar
                  </button>
